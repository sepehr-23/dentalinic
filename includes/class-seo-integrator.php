...
class WPSmartAI_SEO_Integrator {
    ...
    public static function generate_meta_suggestions( $content, $keyword ) {
        $prompt = "تو یک کارشناس فوق‌العاده سئو فارسی هستی. با توجه به محتوای مقاله زیر و کلمه کلیدی اصلی '{$keyword}'، یک عنوان سئوی جذاب (حداکثر ۵5 کاراکتر که حتما با کلمه کلیدی '{$keyword}' شروع شود) و یک توضیحات متای ترغیب‌کننده برای کلیک (حداکثر ۱۴۵ کاراکتر) بنویس.
