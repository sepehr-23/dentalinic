...
<div class="wrap wp-smart-ai-wrap">
    ...
    <div class="wp-smart-ai-card">
        ...
        <p class="description">برای هر مقاله کلمه کلیدی اصلی را مشخص کرده و دکمه ویرایش جادویی را بزنید تا هوش مصنوعی بلافاصله متن را با حفظ تصاویر فعلی سئو کند.</p>
            ...
            <table class="wp-smart-ai-table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 10%;">عملیات جادویی</th>
                    </tr>
                </thead>
                <tbody>
