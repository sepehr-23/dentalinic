...
class WPSmartAI_Admin_Panel {
    ...
    public function ajax_optimize_post() {
        try {
            ...
            $custom_prompt = isset( $_POST['custom_prompt'] ) ? wp_kses_post( wp_unslash( $_POST['custom_prompt'] ) ) : '';
            $custom_links = isset( $_POST['custom_links'] ) ? wp_kses_post( wp_unslash( $_POST['custom_links'] ) ) : '';
            ...
            $english_slug = WPSmartAI_Engine::generate_english_slug( $keyword );
            ...
            // ۵. تبدیل و ساختاربندی به قالب پیشرفته المنتور (Elementor Layout JSON) بر اساس قالب ارسالی شما
    ...
    public function ajax_generate_new_post() {
        try {
            ...
            $custom_prompt = isset( $_POST['custom_prompt'] ) ? wp_kses_post( wp_unslash( $_POST['custom_prompt'] ) ) : '';
            $custom_links = isset( $_POST['custom_links'] ) ? wp_kses_post( wp_unslash( $_POST['custom_links'] ) ) : '';
            $is_pillar = isset( $_POST['is_pillar'] ) ? (bool) $_POST['is_pillar'] : false;
            ...
            // ۳. ایجاد پست جدید در حالت پیش‌نویس
            ...
            // ۶. تبدیل پست به قالب المنتور (Elementor JSON layout)
